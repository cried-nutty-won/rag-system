...
| **Latency cost on CPU** | 0.6B model ~20 ms | 0.6B model 12 s for 18 candidates (sweet spot) |
| **Latency cost on GPU** | 0.6B model ~5 ms or 4B model ~30 ms (sweet spot) | 0.6B model 1 s for 100 candidates (sweet spot) or 4B model 3 s |
