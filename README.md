...
| **Latency cost on CPU with 0.6B models** | ~20 ms | 12 s for 18 candidates (sweet spot) |
| **Latency cost on GPU with 0.6B models** | ~5 ms | 1 s for 100 candidates (sweet spot) |
| **Latency cost on GPU with 4B models** | ~30 ms (sweet spot) | 3 s for 100 candidates |
