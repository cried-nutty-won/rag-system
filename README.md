...
| **Latency cost on CPU** | ~20 ms total | +12 s for 18 candidates (breaks above 21 candidates)|
| **Latency cost on GPU** | ~5 ms total | +1 s for 100 candidates (sweet spot) or +3s with 4B model |
